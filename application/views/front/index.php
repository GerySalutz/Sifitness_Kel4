...
<body>
  <section id="herovideo" class="banner-section-three">
    <div id="bgndVideo" data-property="',containment:'#herovideo', quality:'large', autoPlay:true, loop:true, mute:true, opacity:1}"></div>
    <div class="overlay">
      <div class="container position-relative">
        <div class="row justify-content-center">
          <div class="col-lg-9">
            <div class="banner-content text-center">
              <span class="title-tag wow fadeInDown" data-wow-delay="0.3s"></span>
              <h1 class="title wow fadeInLeft" data-wow-delay="0.5s"></h1>
              <p class="wow fadeInUp" data-wow-delay="0.7s"></p>
